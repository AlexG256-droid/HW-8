...
public class GameTest {
  public static void main(String[] args) {
    try {
      ...
      String savesDirectory = Paths.get("saves").toString();
      ...
      if (files == null || files.length == 0) {
        System.out.println("No JSON files found in the saves directory.");
        return;
      }

      // display available files
      System.out.println("Available game save files:");
      ...
      if (selectedIndex >= 0 && selectedIndex < files.length) {
        ...
        // initialize the GameController with the selected file path
